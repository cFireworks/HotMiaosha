...
import com.cfireworks.order.access.AccessLimit;
import com.cfireworks.order.entity.MiaoshaOrder;
import com.cfireworks.order.entity.MiaoshaUser;
import com.cfireworks.order.rabbitmq.MQSender;
import com.cfireworks.order.rabbitmq.MiaoshaMessage;
import com.cfireworks.order.redis.GoodsKey;
import com.cfireworks.order.redis.MiaoshaKey;
import com.cfireworks.order.redis.OrderKey;
...
public class MiaoshaController implements InitializingBean {
    ...
    public Result<Boolean> reset(Model model) {
        List<GoodsVo> goodsList = goodsService.listGoodsVo();
        for(GoodsVo goods : goodsList) {
            goods.setStockCount(11);
            redisService.set(GoodsKey.getMiaoshaGoodsStock, ""+goods.getId(), 11);
            localOverMap.put(goods.getId(), false);
        }
