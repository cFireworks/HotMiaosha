...
import com.cfireworks.admin.dao.MiaoshaUserDao;
import com.cfireworks.admin.domain.MiaoshaUser;
import com.cfireworks.admin.redis.MiaoshaUserKey;
...
public class MiaoshaUserService {
    ...
    public CodeMsg registerUser(long id, String nickname, String formPass){
        //取user
        MiaoshaUser user = getById(id);
        if(user != null) {
            throw new GlobalException(CodeMsg.MOBILE_HAS_EXISTED);
        }
